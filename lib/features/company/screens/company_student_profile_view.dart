          ...
          body: Directionality(
            ...
            child: FutureBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final cvUrl =
                    data['cvUrl'] ??
                    ''; // Might not be available yet if student didn't upload
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: _buildCVSection(context, cvUrl, isAr),
                            ),
                          ],
                        ),
                      ),
    ...
    return Column(
      children: [
        Container(
          ...
          child: CircleAvatar(
            ...
            child: profileImageUrl.isEmpty
                ? const Icon(Icons.person, size: 60, color: Color(0xFF229BD8))
                : null,
          ),
        ),
        ...
        if (program.isNotEmpty)
          Text(
            "${isAr ? 'البرنامج' : 'Program'}: $program",
            style: const TextStyle(color: Colors.grey, fontSize: 13),
          ),
        if (graduationYear.isNotEmpty)
          Text(
            "${isAr ? 'السنة' : 'Year'}: $graduationYear",
                    ...
                    if (cvUrl.isNotEmpty) {
                      try {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              isAr ? "لا يمكن فتح الملف" : "Could not open CV",
                            ),
